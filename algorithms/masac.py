...
import copy
from marl_uav.algorithms.modules import SACActor,QNetwork
from marl_uav.algorithms.buffer import ReplayBuffer
...
class MASACAgent:
    def __init__(self,obs_dim,action_dim,num_agents,num_obs,args,device):
        ...
        self.q_optimizer = optim.Adam(list(self.q1.parameters())+list(self.q2.parameters()),lr=args.learning_rate)
    ...
    def update(self,batch_size):
        ...
        for param,target_param in zip(self.q1.parameters(),self.q1.parameters()):
            target_param.data.copy_(self.tau*param.data+(1-self.tau)*target_param.data)
        for param,target_param in zip(self.q2.parameters(),self.q2.parameters()):
            target_param.data.copy_(self.tau*param.data+(1-self.tau)*target_param.data)
